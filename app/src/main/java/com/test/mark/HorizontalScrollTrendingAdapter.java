...
public class HorizontalScrollTrendingAdapter extends RecyclerView.Adapter<HorizontalScrollTrendingAdapter.ViewHolder> {

    private List<HorizontalScrollTrendingModel> horizontalScrollTrendingModelList;

    public HorizontalScrollTrendingAdapter(List<HorizontalScrollTrendingModel> horizontalScrollTrendingModelList) {
        this.horizontalScrollTrendingModelList = horizontalScrollTrendingModelList;
    }

    @NonNull
    @Override
    public HorizontalScrollTrendingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bottom_sheet_trending_item_layout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HorizontalScrollTrendingAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(@NonNull final View itemView) {
            ...
            trendingPlaceDist = itemView.findViewById(R.id.trending_distance);
