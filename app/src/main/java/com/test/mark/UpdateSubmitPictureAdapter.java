...
public class UpdateSubmitPictureAdapter extends RecyclerView.Adapter<UpdateSubmitPictureAdapter.ViewHolder> {

    private List<PlacesPictureModel> placesPictureModelList;

    public UpdateSubmitPictureAdapter(List<PlacesPictureModel> placesPictureModelList) {
        this.placesPictureModelList = placesPictureModelList;
    }

    @NonNull
    @Override
    public UpdateSubmitPictureAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.update_submit_picture_item_layout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UpdateSubmitPictureAdapter.ViewHolder holder, int position) {
